...
public class PartitionController {
    ...
    @Autowired
    public PartitionController(PdfService pdfService) {
        this.pdfService = pdfService;
    }

    /**
     * Endpoint pour combiner plusieurs images de partition en un seul fichier PDF
    ...
    public ResponseEntity<?> combinePartitionImagesToPdf(
        ...
        try {
            ...
            // Générer le PDF avec un nom spécifique pour les partitions
            PdfService.PdfResult result = pdfService.combineImagesToPdfWithName(images, "partition");
